...
const fs = require('fs');
 // FIRST: find a url of a page you are interested in from wikipedia 
const url = "https://en.wikipedia.org/wiki/Moon"; // FIRST: find a url of a page you are interested in from wikipedia 
...
function getAllExternalLinks(soupTag){
    let aTags = soupTag.findAll('b'); // return an array of SoupTag object
    let links = [];
